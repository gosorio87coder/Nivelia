      ...
      case 'textarea':
        return (
          <form onSubmit={handleTextSubmit} className="mt-6 space-y-4">
            ...
            <button type="submit" className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400" disabled={!textValue.trim()}>
              Siguiente
            </button>
          </form>
        );
