        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 max-w-4xl mx-auto">
                <ul className="space-y-4">
                    <li className="flex items-center text-lg text-gray-700"><CheckIcon className="h-6 w-6 text-teal-500 mr-3 flex-shrink-0" />Agentes IA para WhatsApp/Email que responden en &lt;2 min.</li>
                    <li className="flex items-center text-lg text-gray-700"><CheckIcon className="h-6 w-6 text-teal-500 mr-3 flex-shrink-0" />Embudos y sistemas de venta de alta productividad.</li>
                    <li className="flex items-center text-lg text-gray-700"><CheckIcon className="h-6 w-6 text-teal-500 mr-3 flex-shrink-0" />Control de gestión: pricing, inventarios, compras, campañas promocionales y más.</li>
                </ul>
            </div>
                ...
                {solutionsData[activeSolutionTab].map((item, index) => (
                  <div key={index} className="pl-12 relative">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 -translate-x-1/2">
                      <div className="w-4 h-4 rounded-full bg-indigo-600 ring-8 ring-gray-50"></div>
                    </div>
                    <div>
